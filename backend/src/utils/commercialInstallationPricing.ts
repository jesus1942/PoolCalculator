...
const isCirconModel = (project: any) => {
...
export const hasHeatingInstallation = (project: any) => {
 ...
 */
const getFixedTariffAdjustments = (project: any, baseAmount: number) => {
...
export const getCommercialBaseInstallationLabor = (project: any) => {
...
export const getProjectPipeSystemLabel = (project: any): string => {
  const config = (project as any)?.plumbingConfig;
 ...
 */
export const getInstallationConditionHighlights = (project: any): string[] => {
  const config = (project as any)?.plumbingConfig;
  const plumbingConfig = config && typeof config === 'object' ? config : {};
  const factors = plumbingConfig.installationFactors && typeof plumbingConfig.installationFactors === 'object'
    ? plumbingConfig.installationFactors
...
export const getCommercialInstallationProfile = (project: any) => {
