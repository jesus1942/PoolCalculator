        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Pool Calculator</h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl md:text-4xl font-bold mb-6">
                Por qué elegir Pool Calculator
              </h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-blue-100 mb-6">
                {isAuthenticated
                  ...
                  : 'Únete a los instaladores profesionales que ya confían en Pool Calculator'
                }
              </p>
              <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-white font-semibold">Pool Calculator</p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
            © 2025 Pool Calculator. Todos los derechos reservados.
          </div>
        </div>
      </footer>
    </div>
