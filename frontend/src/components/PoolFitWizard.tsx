...
import { HdRuler, HdArrowRight, HdArrowLeft, HdCheck, HdAlertTriangle, HdLayoutGrid, HdSparkles, HdDollarSign, HdPackage, HdCalendar, HdLightbulb, HdTrendingUp, HdDroplet, HdClock, HdZap, HdFilter, HdFlame } from '@/components/ui/HandDrawnIcons';
          ...
          <div className="relative p-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                <div className="relative">
                  ...
                  <div className="relative p-4 rounded-2xl bg-gradient-to-br from-purple-600 to-pink-600 shadow-xl shadow-purple-500/20">
                    <HdSparkles className="h-8 w-8 text-white" />
                  </div>
                </div>
                <div>
              ...
              <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <HdArrowRight className="text-purple-400" size={32} />
              </div>
            </div>
          </div>
      ...
      >
        <div className="space-y-6">
          ...
          {currentStep === 1 && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-4">
                <HdRuler className="text-purple-600" size={24} />
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mt-4">
                <div className="flex items-start gap-2">
                  <HdLightbulb className="w-5 h-5 text-purple-600 flex-shrink-0 mt-0.5" />
              ...
              <Button onClick={() => setCurrentStep(2)} className="w-full mt-4">
                Continuar
                <HdArrowRight size={20} className="ml-2" />
              </Button>
            </div>
          )}
          ...
          {currentStep === 2 && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-4">
                <HdLayoutGrid className="text-purple-600" size={24} />
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start gap-2">
                  <HdRuler className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
              ...
              <div className="flex gap-3 mt-4">
                <Button variant="secondary" onClick={() => setCurrentStep(1)} className="flex-1">
                  <HdArrowLeft size={20} className="mr-2" />
                  Atrás
                </Button>
            ...
            <div className="space-y-4">
              ...
              {fitResults.length === 0 ? (
                <div className="text-center py-8">
                  <HdAlertTriangle size={48} className="text-orange-500 mx-auto mb-4" />
                        ...
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              {index === 0 && <HdCheck size={20} className="text-green-600" />}
                        ...
                        {index === 0 && (
                          <div className="mt-3 bg-green-100 border border-green-300 rounded px-3 py-2">
                            <div className="flex items-center gap-2">
                              <HdCheck className="w-4 h-4 text-green-600" />
          ...
          {currentStep === 4 && selectedPool && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-4">
                <HdZap className="text-blue-600" size={24} />
                <h3 className="text-lg font-bold">Selecciona los Equipos a Instalar</h3>
              </div>

              <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4 mb-4">
                <div className="flex items-start gap-3">
                  <HdSparkles className="text-purple-600 flex-shrink-0 mt-1" size={20} />
                  <div>
              ...
              <Card className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <HdZap className="text-orange-600" size={20} />
                  ...
                  {recommendedEquipment.pump && selectedEquipment.pump?.id !== recommendedEquipment.pump.id && (
                    ...
                    >
                      <HdSparkles size={14} className="mr-1" />
                      Usar Recomendación
                    </Button>
                  )}
                </div>
                ...
                {recommendedEquipment.pump && (
                  <div className="mb-3 p-2 bg-purple-50 border border-purple-200 rounded-lg">
                    <div className="flex items-start gap-2">
                      <HdSparkles className="text-purple-600 flex-shrink-0 mt-0.5" size={16} />
              ...
              <Card className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <HdFilter className="text-blue-600" size={20} />
              ...
              <Card className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  <HdFlame className="text-red-600" size={20} />
              ...
              <Card className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  <HdDroplet className="text-cyan-600" size={20} />
          ...
          {currentStep === 5 && selectedPool && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-4">
                <HdCheck className="text-green-600" size={24} />
              ...
              {(() => {
                ...
                return (
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4 mb-4">
                    <div className="flex items-center gap-2 mb-3">
                      <HdDollarSign className="text-green-600" size={20} />
              ...
              {(() => {
                ...
                return (
                  <div className="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-lg p-4 mb-4">
                    <div className="flex items-center gap-2 mb-3">
                      <HdPackage className="text-orange-600" size={20} />
              ...
              {(() => {
                ...
                return (
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-4 mb-4">
                    <div className="flex items-center gap-2 mb-3">
                      <HdCalendar className="text-purple-600" size={20} />
                    ...
                    <div className="bg-white rounded-lg p-3 border border-purple-100 mb-3">
                      <div className="flex items-center gap-2 mb-2">
                        <HdLightbulb className="text-yellow-500" size={16} />
              ...
              <div className="flex gap-3 mt-6">
                ...
                >
                  ...
                  <HdCheck size={20} className="ml-2" />
                </Button>
              </div>
            </div>
          )}
